...
Public Class PoMo
    ...
    Function SQLSTRing()
        ...
        If RadioButton10.Checked = True Then
            SQLTXT = "select  POSTB.TB034 as 活動代號,POSTB.TB036 as 特價代號,POSTB.TB010 as 活動品號,INVMB.MB002 as 商品名稱,Case ATB.銷售總數量 when null THEN 0 ELSE ATB.銷售總數量 end AS 銷售總數量 ,case ATB.原價銷售總額 when null then 0 else ATB.原價銷售總額 end as 原價銷售總額 ,case ATB.促銷折價總額 when null then 0 else ATB.促銷折價總額 end as 促銷折價總額 ,case ATB.促銷銷售總額 when null then 0 else ATB.促銷銷售總額 end as 促銷銷售總額 ,case JO2.加購數量 when null then 0 else JO2.加購數量 end as 加購數量,case JO2.加購折價金額 when null then 0 else JO2.加購數量 end as 加購折價金額,case  JO2.加購銷售總額 when null then 0 else JO2.加購銷售總額 end as 加購銷售總額 ,case JO1.贈品數量 when null then 0 else 贈品數量 end as 贈品數量,case JO1.贈品折價金額 when null then 0 else JO1.贈品折價金額 end  as 贈品折價金額   from POSTB 
inner join INVMB on POSTB.TB010=INVMB.MB001                                      
left join (Select POSTB.TB034,POSTB.TB036,POSTB.TB049,POSTB.TB010,CAST(sum(TB019) AS decimal(7)) as 銷售總數量, CAST(sum(TB018*TB019) AS decimal(7)) as 原價銷售總額,CAST(sum(TB025) AS decimal(7))  as 促銷折價總額, CAST(sum(TB033) AS decimal(7))  as 促銷銷售總額  from POSTB  where (TB042='1' or TB042='2') and TB049='' and POSTB.TB034=@MTB034 and POSTB.TB036=@MTB036   and ( POSTB.TB001>=@Sdate and TB001<=@Edate)  group by TB034,TB036,TB049,TB010  ) as ATB on  POSTB.TB034=ATB.TB034 and  POSTB.TB036=ATB.TB036  and  POSTB.TB010=ATB.TB010 

left join (Select TB034,TB036,TB010 ,CAST(sum(TB019) AS decimal(7)) as 加購數量, sum(TB033) as 加購銷售總額,sum(TB025) as 加購折價金額 FROM POSTB  where (TB042='1' or TB042='2') and TB049='2' and TB034=@MTB034  and TB036=@MTB036 and ( TB001>=@Sdate and TB001<=@Edate) group by TB034,TB036,TB010,TB036) as JO2 on POSTB.TB034=JO2.TB034 and  POSTB.TB036=JO2.TB036  and  POSTB.TB010=JO2.TB010 

left join (Select TB034,TB036,TB010 ,CAST(sum(TB019) AS decimal(7)) as 贈品數量, sum(TB025) as 贈品折價金額 FROM POSTB  where TB042='3' and TB049='1' and TB034=@MTB034 and TB036=@MTB036  and ( TB001>=@Sdate and TB001<=@Edate) group by TB034,TB036,TB010) as JO1 on POSTB.TB034=JO1.TB034 and  POSTB.TB036=JO1.TB036 and  POSTB.TB010=JO1.TB010 
...
where POSTB.TB034=@MTB034 and POSTB.TB036=@MTB036 and ( POSTB.TB001>=@Sdate and POSTB.TB001<=@Edate) group by POSTB.TB034 ,POSTB.TB036 ,POSTB.TB010 ,INVMB.MB002 ,ATB.銷售總數量,ATB.原價銷售總額,ATB.促銷折價總額 ,ATB.促銷銷售總額,JO2.加購數量 ,JO2.加購折價金額 ,JO2.加購銷售總額 ,JO1.贈品數量 ,JO1.贈品折價金額 "
        ...
        If RadioButton11.Checked = True Then
            SQLTXT = "select  POSTB.TB034 as 活動代號,POSTB.TB036 as 特價代號,POSTB.TB010 as 活動品號,INVMB.MB002 as 商品名稱,ATB.門市代號,Case ATB.銷售總數量 when null THEN 0 ELSE ATB.銷售總數量 end AS 銷售總數量 ,case ATB.原價銷售總額 when null then 0 else ATB.原價銷售總額 end as 原價銷售總額 ,case ATB.促銷折價總額 when null then 0 else ATB.促銷折價總額 end as 促銷折價總額 ,case ATB.促銷銷售總額 when null then 0 else ATB.促銷銷售總額 end as 促銷銷售總額 ,case JO2.加購數量 when null then 0 else JO2.加購數量 end as 加購數量,case JO2.加購折價金額 when null then 0 else JO2.加購數量 end as 加購折價金額,case  JO2.加購銷售總額 when null then 0 else JO2.加購銷售總額 end as 加購銷售總額 ,case JO1.贈品數量 when null then 0 else 贈品數量 end as 贈品數量,case JO1.贈品折價金額 when null then 0 else JO1.贈品折價金額 end  as 贈品折價金額   from POSTB 
inner join INVMB on POSTB.TB010=INVMB.MB001                                      
left join (Select POSTB.TB034,POSTB.TB036,POSTB.TB049,POSTB.TB002 as 門市代號,POSTB.TB010,CAST(sum(TB019) AS decimal(7)) as 銷售總數量, CAST(sum(TB018*TB019) AS decimal(7)) as 原價銷售總額,CAST(sum(TB025) AS decimal(7))  as 促銷折價總額, CAST(sum(TB033) AS decimal(7))  as 促銷銷售總額  from POSTB  where (TB042='1' or TB042='2') and TB049='' and POSTB.TB034=@MTB034 and POSTB.TB036=@MTB036   and ( POSTB.TB001>=@Sdate and TB001<=@Edate)  group by TB034,TB036,TB049,TB010,TB002  ) as ATB on  POSTB.TB034=ATB.TB034 and  POSTB.TB036=ATB.TB036  and  POSTB.TB010=ATB.TB010 
...
where POSTB.TB034=@MTB034 and POSTB.TB036=@MTB036 and ( POSTB.TB001>=@Sdate and POSTB.TB001<=@Edate) group by POSTB.TB034 ,POSTB.TB036 ,POSTB.TB010 ,INVMB.MB002 ,ATB.門市代號 ,ATB.銷售總數量,ATB.原價銷售總額,ATB.促銷折價總額 ,ATB.促銷銷售總額,JO2.加購數量 ,JO2.加購折價金額 ,JO2.加購銷售總額 ,JO1.贈品數量 ,JO1.贈品折價金額 "
        ...
        If RadioButton12.Checked = True Then
            ...
            SQLTXT = "select  POSTB.TB034 as 活動代號,POSTB.TB036 as 特價代號,POSTB.TB010 as 活動品號,INVMB.MB002 as 商品名稱,ATB.門市代號,Case ATB.銷售總數量 when null THEN 0 ELSE ATB.銷售總數量 end AS 銷售總數量 ,case ATB.原價銷售總額 when null then 0 else ATB.原價銷售總額 end as 原價銷售總額 ,case ATB.促銷折價總額 when null then 0 else ATB.促銷折價總額 end as 促銷折價總額 ,case ATB.促銷銷售總額 when null then 0 else ATB.促銷銷售總額 end as 促銷銷售總額 ,case JO2.加購數量 when null then 0 else JO2.加購數量 end as 加購數量,case JO2.加購折價金額 when null then 0 else JO2.加購數量 end as 加購折價金額,case  JO2.加購銷售總額 when null then 0 else JO2.加購銷售總額 end as 加購銷售總額 ,case JO1.贈品數量 when null then 0 else 贈品數量 end as 贈品數量,case JO1.贈品折價金額 when null then 0 else JO1.贈品折價金額 end  as 贈品折價金額   from POSTB 
inner join INVMB on POSTB.TB010=INVMB.MB001                                      
left join (Select POSTB.TB034,POSTB.TB036,POSTB.TB049,POSTB.TB002 as 門市代號,POSTB.TB010,CAST(sum(TB019) AS decimal(7)) as 銷售總數量, CAST(sum(TB018*TB019) AS decimal(7)) as 原價銷售總額,CAST(sum(TB025) AS decimal(7))  as 促銷折價總額, CAST(sum(TB033) AS decimal(7))  as 促銷銷售總額  from POSTB  where (TB042='1' or TB042='2') and TB049='' and POSTB.TB034=@MTB034 and POSTB.TB036=@MTB036 and POSTB.TB002=@PSTATION  and ( POSTB.TB001>=@Sdate and TB001<=@Edate)  group by TB034,TB036,TB049,TB010,TB002  ) as ATB on  POSTB.TB034=ATB.TB034 and  POSTB.TB036=ATB.TB036  and  POSTB.TB010=ATB.TB010 

left join (Select TB034,TB036,TB010 ,CAST(sum(TB019) AS decimal(7)) as 加購數量, sum(TB033) as 加購銷售總額,sum(TB025) as 加購折價金額 FROM POSTB  where (TB042='1' or TB042='2') and TB049='2' and TB034=@MTB034  and TB036=@MTB036  and TB002=@PSTATION and ( TB001>=@Sdate and TB001<=@Edate) group by TB034,TB036,TB010,TB036) as JO2 on POSTB.TB034=JO2.TB034 and  POSTB.TB036=JO2.TB036  and  POSTB.TB010=JO2.TB010 
...
where POSTB.TB034=@MTB034 and POSTB.TB036=@MTB036 and ( POSTB.TB001>=@Sdate and POSTB.TB001<=@Edate) group by POSTB.TB034 ,POSTB.TB036 ,POSTB.TB010 ,INVMB.MB002 ,ATB.門市代號 ,ATB.銷售總數量,ATB.原價銷售總額,ATB.促銷折價總額 ,ATB.促銷銷售總額,JO2.加購數量 ,JO2.加購折價金額 ,JO2.加購銷售總額 ,JO1.贈品數量 ,JO1.贈品折價金額 "
    ...
    Private Sub ComboBox2_DrawItem(sender As Object, e As DrawItemEventArgs) Handles ComboBox2.DrawItem
        ...
        If Me.RadioButton6.Checked Then
            Dim MM003 As String = drv("MM003").ToString()
            Dim MM004 As String = drv("MM004").ToString()
            'Dim MB003 As String = drv("MB003").ToString()
            Dim r1 As Rectangle = e.Bounds
            r1.Width = r1.Width - Int(r1.Width / 3) * 2
            Using sb As SolidBrush = New SolidBrush(e.ForeColor)
                e.Graphics.DrawString(MM003, e.Font, sb, r1)
            End Using
            ...
            Using sb As SolidBrush = New SolidBrush(e.ForeColor)
                e.Graphics.DrawString(MM004, e.Font, sb, r2)
            End Using
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Try
            ...
            DataGridView1.Columns("銷售總數量").DefaultCellStyle.Format = "###,###,##0"
            ...
            DataGridView1.Columns("原價銷售總額").DefaultCellStyle.Format = "###,###,##0"
            ...
            DataGridView1.Columns("促銷折價總額").DefaultCellStyle.Format = "###,###,##0"
            ...
            DataGridView1.Columns("促銷銷售總額").DefaultCellStyle.Format = "###,###,##0"
            ...
            DataGridView1.Columns("加購數量").DefaultCellStyle.Format = "###,###,##0"
            ...
            DataGridView1.Columns("加購折價金額").DefaultCellStyle.Format = "###,###,##0"
            ...
            DataGridView1.Columns("加購銷售總額").DefaultCellStyle.Format = "###,###,##0"
            ...
            DataGridView1.Columns("贈品數量").DefaultCellStyle.Format = "###,###,##0"
            ...
            DataGridView1.Columns("贈品折價金額").DefaultCellStyle.Format = "###,###,##0"
        ...
        If Me.RadioButton11.Checked = False Then
            ...
            For Each row As DataRow In Main.Dss.Tables("POSTB").Rows
    ...
    Private Sub RadioButton6_Click(sender As Object, e As EventArgs) Handles RadioButton6.Click
        TextBox2.Text = ""
        conn = New SqlConnection(ConnString)
        selectcmd = "Select MM003,MM004 FROM POSMM where MM015='Y' and MM001='" + Me.ComboBox1.SelectedItem(0) + "'"
